...
{
    /**
     * @return array{summary: array<string, mixed>, records: array<int, array<string, mixed>>, generatedAt: mixed}
     */
    public function getPayload(): array
    {
        return (new RsvpReportService())->getDashboardPayload();
    }

    public function buildExcelBinary(): string
    {
    ...
    public function buildPdfBinary(): string
    {
        $payload = $this->getPayload();
